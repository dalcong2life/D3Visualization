...
???
배열형식의 데이터를 이용해서 표현 할 수 있는 차트의 종류들...
하나씩 
...
<p>- 전체량과 동시에 하나의 막대를 구성하는 데터를 시각화</p>
<br>
...
오른쪽 그림의 각 요소의 합한값의 높이를 정규화 해서 각 지역에서 나이대별 차지하고 있는 비율을 표현할 수 있습니다 
...
<p>- 비율 표현에 적합하지만 각도와 면적을 정확하게 표현하기 어려움</p>
<p>- 표현할 내용을 다섯 개 이하로 제한</p>
<p>- 누적 막대그프(띠그래프)로 대체 가능</p>
...
canvas 도 HTML 문서요소 중 하나로써 스크립트를 이용해서 그림을 그리는데 사용됩니다.
